...
const LoginForm = () => {
  ...
  const submit = () => {
    data.filter(e => {
      if (e.email == "admin@gamil.com" && e.password == "1234567890") {
        count = 1
        setLogin(e)
  ...
  return (
    <div>
      ...
      <div className='flex justify-between'>
        ...
        <button className='btn w-40  bg-gray-100  btn-xs sm:btn-sm md:btn-sm lg:btn-md' onClick={() => navigate('/register')}>CreateAccount</button>
      </div>
    </div>
  )
}
