...
const AddProduct = () => {
  ...
  return (
    <div className='m-auto w-11/12 flex justify-center md:min-w-full'>
     ...
     <label className="input input-bordered flex  items-center gap-2 m-3 w-80  sm:w-96 md:w-5/12 md:h-16">
...
<label className="input input-bordered flex items-center gap-2m m-3 w-80 sm:w-96 md:w-5/12 md:h-16">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-4 h-4 opacity-70"><path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6ZM12.735 14c.618 0 1.093-.561.872-1.139a6.002 6.002 0 0 0-11.215 0c-.22.578.254 1.139.872 1.139h9.47Z" /></svg>
