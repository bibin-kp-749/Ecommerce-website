...
const BottomNavbar = () => {
  ...
  <button className='bottom-btn shadow-md shadow-gray-700 bg-white rounded-md  items-center'>
  ...
  <button className='bottom-btn shadow-md  shadow-gray-700 bg-white rounded-md   flex items-center justify-center'>
  ...
  <button className='bottom-btn shadow-md  shadow-gray-700 bg-white rounded-md flex items-center'>
